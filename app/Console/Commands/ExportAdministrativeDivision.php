...
class ExportAdministrativeDivision extends Command
{
     ...
     * @var string
     */
    protected $signature = 'export:administrative';
    ...
    public function handle()
    {
        ...
        foreach($provinces as $province) {
            ...
            $districts = AU::all()->unique('l2_code')->filter(function($district) use ($province){
            ...
            if ($districts->count() > 1) {
                ...
                $districts->each(function($district) use ($tinh, $province){
                    ...
                    $wards = AU::all()->unique('l3_code')->filter(function($ward) use ($district){
